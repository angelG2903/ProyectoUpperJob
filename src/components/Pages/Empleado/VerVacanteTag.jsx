        ...
        <>
            <section className="margenes">
                ...
                <div className="text-img">
                    <Tag TextName='En proceso...' style='tag-color'/>
                    <div className="txt-i">
                ...
                <div className="butt-end">
                    <Button TextName='Cancelar postulación' style={'btt-end'}/>
                    <Button TextName='Evaluar empresa' style={'btt2-end'}/>
                </div>
